    ...
    <nav class="navbar navbar-light navbar-expand-lg navigation-clean-button">
        <div class="container">
          <a class="navbar-brand" href="#">
            <span>
              <img style="max-height: 80px" src="{{ secure_asset('assets/img/logo2.png') }}" alt="">
            </span>
            CSISE
          </a>
          <button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><span class="navbar-text actions"> <a class="login" href="#">STAFF&nbsp;&nbsp;</a><a class="btn btn-light action-button" role="button" href="#">STUDENT&nbsp;</a></span>
            </div>
        </div>
    </nav>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <footer class="footer-basic">
                    ...
                    <p class="copyright">CSISE © 2022</p>
                </footer>
            </div>
        </div>
    </div>
