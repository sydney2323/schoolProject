...
<body class="d-flex flex-column min-vh-100">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/staff" class="logo d-flex align-items-center">
        <img style="max-height: 55px" src="{{ asset('assets/img/logo2.png') }}" alt="">
        <span class="d-none d-lg-block" style="font-size: 25px">AIS STUDENT</span>
      </a>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">
              ...
              @php
                $f_name = Auth::guard('student')->user()->f_name; 
                $l_name = Auth::guard('student')->user()->l_name; 
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/student/profile">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/student/online-class">
          <i class="bi bi-tv"></i>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <a href="/student/logout" class="btn btn-sm btn-danger">Logout</a>
          </div>
        </div>
      </div>
    </div><!-- End Basic Modal-->
